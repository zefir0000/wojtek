!(function (t, e) {
  ...
  return (function () {
      ...
      (this.addOnSelectEvent = function (t) {
        ...
        (this.checkDateTimeConsistency = function () {
          ...
          if ((e <= t && this.start_date.setHours(this.first_date.getHours(), this.first_date.getMinutes(), 0, 0), e >= n && this.start_date.setHours(this.last_date.getHours(), this.last_date.getMinutes(), 0, 0), this.end_date)) {
            ...
            "start" == o
              ? e + this.min_range >= a && (e + this.min_range >= n && this.start_date.setTime(n - this.min_range), this.end_date.setTime(this.start_date.getTime() + this.min_range), this.printDateAndTime(this.end_container, this.end_date))
              : (a - this.min_range <= e &&
        ...
        (this.getDayClassName = function (t, e, n, setD) {
          var a = new Date(e.getFullYear(), e.getMonth(), t).getTime(),
            i = "day ";
            let b = new Date(e.getFullYear(), e.getMonth(), t).toLocaleDateString();
            let arrD = setD.map(d => new Date(d).toLocaleDateString());
          return (
            !arrD.includes(b) || a < n._first_date || a > n._last_date ? (i += "disabled ") : (i += "selectable "),
            // a == n._today && (i += "today "),
            arrD.includes(b) && (i += "setted "),
            // !arrD.includes(b) && (i += "disabled "),
        ...
        (this.getHTML = function (t, e, n) {
          ...
          if ("datetime" === e)
            a = '<div class="buttons-container fix-float">\n          <button type="button" class="date '
              .concat(
                t,
        ...
        (this.selectDay = function (t) {
          ...
          for (var e = this.get_Dates(), n = document.querySelectorAll("td.selectable"), a = 0, i = n.length; a < i; a++) {
            ...
            n[a].classList.contains("prev-month") ? ((s = this.prev_month), (r += "prev-month ")) : n[a].classList.contains("next-month") ? ((s = this.next_month), (r += "next-month ")) : (s = this.current_month),
              (r += this.getDayClassName(n[a].textContent, s, e, this.setD)),
              (n[a].className = r);
          }
        ...
        (this.showDatePicker = function (t, e) {
          for (
            ...
            (v = y - (f - 1)), (a = this.getDayClassName(v, _, m, sd)), (r += '<td class="prev-month '.concat(a, '">').concat(v, "</td>")), f--;
          for (v = 1; v <= l[o]; ) u > 6 && ((u = 0), (r += "</tr><tr>")), (a = this.getDayClassName(v, h, m, sd)), (r += '<td class="'.concat(a, '">').concat(v, "</td>")), u++, v++;
          for (v = 1; u <= 6; u++, v++) (a = this.getDayClassName(v, p, m, sd)), (r += '<td class="next-month '.concat(a, '">').concat(v, "</td>"));
        ...
        (this.showTimePicker = function (t, e) {
          ...
          var hour_range = this.hourA;
          for (
            var a,
              i = hour_range ? hour_range : [
                "00:00",
                "00:30",
                "01:00",
                "01:30",
    ...
    function a(t) {
      ...
      n.call(this), (this.i18n = e.l10n ? e.l10n : this.i18n), (this.setD = e.set_dates ? e.set_dates : this.setD), (this.date_output = e.date_output ? e.date_output : "short_ISO");
    ...
    function p(t) {
      var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      console.log(e)
      n.call(this), (this.i18n = e.l10n ? e.l10n : this.i18n), (this.hourA = e.hours_range ? e.hours_range : this.hourA), (this.round_to = !!e.round_to && e.round_to), (this.date_output = e.date_output ? e.date_output : "full_ISO");
      var a = e.start_date ? e.start_date : null,
        i = e.first_date ? e.first_date : null,
        s = e.last_date ? e.last_date : null,
        r = void 0 !== e.first_day_no ? e.first_day_no : 0,
      ...
      this.setStartPickerProps(t, a, i, s, r),
        this.start_container.classList.add("datetime-container", "fix-float"),
        this.start_container.insertAdjacentHTML("afterbegin", this.getHTML("start", "time", o)),
        this.printDateAndTime(this.start_container, this.start_date),
        (this.start_time_btn = this.start_container.querySelector("button.time.start")),
        (this.start_date_btn = this.start_container.querySelector("button.date.start")),
        (this.start_picker = this.start_container.querySelector("div.picker")),
